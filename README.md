...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/mrotttamil/MR-INSTA-DL)
...
1. Clone the repo
   ```markdown
   git clone https://github.com/mrotttamil/MR-INSTA-DL
   ```
